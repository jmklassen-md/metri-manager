...
export default function Page() {
  ...
  const buildOfferMessage = (candidate: Shift) => {
    ...
    const contactLine = contactBits
      ? `Please contact ${meName} at ${contactBits} if you're interested.`
      : `Please contact ${meName} if you're interested.`;

    return `You've got a SAME DAY SHIFT TRADE OFFER from ${meName}!

${meName} would like to trade:
...
(Generated by the SBH Shift Trade Helper – mode: Same-Day Trades.)`;
  };
